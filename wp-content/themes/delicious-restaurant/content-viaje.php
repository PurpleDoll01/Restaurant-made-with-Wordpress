        ...
        <div class="campos_viaje">
            <div class="campo_viaje">
                ...
                <div class="viaje_valor">
                    <?php echo $campos_viaje['destino_'][0]; ?>
                </div>
            </div>
            <div class="campo_viaje">
                <div class="viaje_label">
                ...
                <div class="viaje_valor">
                    <?php echo $campos_viaje['vacunas_obligatorias_'][0]; ?>
                </div>
            </div>
            <div class="campo_viaje">
                <div class="viaje_label">
                ...
                <div class="viaje_valor">
                    <?php echo $campos_viaje['vacunas_recomendadas_'][0]; ?>
                </div>
            </div>
            <div class="campo_viaje">
                <div class="viaje_label">
                ...
                <div class="viaje_valor">
                    <?php echo $campos_viaje['peligrosidad_'][0]; ?>
                </div>
            </div>
            <div class="campo_viaje">
                <div class="viaje_label">
                ...
                <div class="viaje_valor">
                    <?php echo $campos_viaje['moneda_local_'][0]; ?>
                </div>
            </div>
        </div>
        <?php
